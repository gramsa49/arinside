...
class CDocFilterHelper
{
public:
	CDocFilterHelper(CARInside &arInside, CARServerObject &arServerObject, int structItemType);
	~CDocFilterHelper(void);
